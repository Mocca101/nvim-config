  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        -- (Overwrite)/Define default behaviours in general or for specific pickers
        -- A picker is e.g. a specific modal, e.g. the `telescope.builin`(s)
        --
        defaults = {
      ...
      vim.keymap.set('n', '<leader>sc', builtin.colorscheme, { desc = '[S]earch [C]olour Scheme' })
      ...
      end, { desc = '[S]earch [P] in Git Project' })
      ...
      vim.keymap.set('n', '<leader>np', function() end, { desc = 'Search [n]ode [p]roject files' })
    end,
  },
}
